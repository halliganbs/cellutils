...
@click.option('--base_path', '-b', help='Location of Images')
@click.option('--mask_path', '-m', help='Path to masks')
def get_crops(
    ...
    conn.close()
    filtered_df = filter_cells(df, maskpath=mask_path, min_diameter=100)
    ...
    for index, row in sampled_df.iterrows():
        ...
        mask_path = f"{mask_names['plate_type']}_{well_id}_{mask_names['timepoint']}{field_id_formatted}{mask_names['location']}{mask_names['wid']}{mask_names['zstack']}{mask_names['channel']}.tif"
